<?php				
include "dbcon.php";
				   $query = "SHOW DATABASES LIKE 'feedback'";
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" name="loginform" action="newuser.php" method="post" role="form" style="display: block;" onsubmit="return validateformlogin()" autocomplete="off">
